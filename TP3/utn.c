 ...
 */
 int utn_esTelefonoAvanzada (char cadena [])
 {
     ...
     while (cadena[i]!= '\0')
     {
         ...
         if ((contadorGuiones ==2) && (contadorCaracteres ==12) &&(retorno != 0))
             retorno=1;
         else
             retorno=0;
 ...
 */
 int utn_esDniAvanzada(char cadena [])
 {
     ...
     while (cadena[i]!= '\0')
     {
         ...
         if ((contadorCaracteres ==8) &&(retorno != 0))
             retorno=1;
         else
             retorno=0;
 ...
 */
 int utn_esCuilAvanzada(char cadena [])
 {
     ...
     while (cadena[i]!= '\0')
     {
         ...
         if ((contadorGuiones ==2) && (contadorCaracteres ==13) &&(retorno != 0))
             retorno=1;
         else
             retorno=0;
 ...
 */
 int utn_esMailAvanzada(char cadena [])
 {
     ...
     while (cadena[i]!= '\0')
     {
         ...
         if ((cadena[i] != '-') && (cadena[i] < '0' || cadena[i] > '9') && (cadena[i] < 'a' || cadena[i] > 'z') && (cadena[i] != '_') && (cadena[i] != '.') && (cadena[i] != '@'))
             retorno= 0;

         i++;
     }
         if ((contadorPuntos >= 1) && (contadorA==1) &&(retorno != 0))
             retorno=1;
         else
             retorno=0;
 ...
 */
 ...
 char* getDynamicString (char* message)
 {
     ...
     auxString= (char*) malloc(sizeof(char)*1024);

     scanf("%1023s", auxString);

     leng=strlen(auxString);

     auxString= (char*) realloc (auxString, sizeof(char) * (leng +1));
